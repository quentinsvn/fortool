        ...
        <div class="col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header card-head-inverse bg-warning bg-darken-4">
                <h4 class="card-title">Inviter des amis</h4>
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                    <fieldset class="mb-2">
                        <p>En invitant vos amis depuis votre lien de parrainage, vous et lui toucheraient <strong>jusqu'à 5%</strong> de chaque somme des tâches que vous réaliserez. Votre lien de parrainage est unique et ne peux être modifié.</p>
                        <div class="input-group">
                            <input value="https://fortool.fr/account/register.php?ref=<?php echo $user['uniqid']; ?>" type="text" class="form-control" id="referralInput" placeholder="Mon lien de parrainage" aria-describedby="button-addon2">
