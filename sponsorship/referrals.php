...
if(isset($_SESSION['id'])) {
  ...
  $referrals = $bdd->query('SELECT * FROM users ORDER BY date_inscription DESC');
?>
<!DOCTYPE html>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left ml-1 col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Parrainage</strong></h3>
            </div>
            <div class="content-body ml-1">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Mes filleuls</h4>
                            </div>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Pseudo</th>
                                                    <th>Solde du parrain</th>
                                                    <th>Gains gagnés</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                while ($r = $referrals->fetch()) {
                                                  if ($user['id'] == $r['id_parrain']) {
                                                ?>
                                                <tr>
                                                    <td class="align-middle">
                                                        <span class="text-truncate">
                                                          <?php
                                                              $phpdate = strtotime($r['date_inscription']);
                                                              $r['date_inscription'] = date('d/m/Y', $phpdate);
                                                              echo $r['date_inscription'];
                                                          ?>
                                                        </span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <span>
                                                          <?php
                                                              $phpdate2 = strtotime($r['date_connexion']);
                                                              $r['date_connexion'] = date('d/m/Y H:m:s', $phpdate2);
                                                              echo $r['date_connexion'];
                                                          ?>
                                                        </span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <span><?php echo $r['pseudo']; ?></span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <span><?php echo $r['solde']; ?> Fortcoins</span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <span>0 Fortcoins</span>
                                                    </td>
                                                </tr>
                                                <?php }
                                                } ?>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                              <h4 class="card-title">Inviter</h4>
                            </div>
                            <div class="card-content collapse show">
                              <div class="card-body">
                                  <fieldset class="mb-2">
                                      <div class="input-group">
                                          <input id="referralInput" value="https://fortool.fr/account/register.php?ref=<?php echo $user['uniqid']; ?>" type="text" class="form-control" placeholder="Mon lien de parrainage" aria-describedby="button-addon2">
                                          <div class="input-group-append" id="button-addon2">
                                              <button onclick="copyFunction()" class="btn btn-primary" type="button"><i class="fas fa-clipboard"></i></button>
                                          </div>
                                      </div>
                                  </fieldset>
                                  <ul class="list-group">
