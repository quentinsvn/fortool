<?php
    ...
    if(isset($_SESSION['id'])) {
        ...
        $user = $requser->fetch();
        $activity = $bdd->query('SELECT * FROM activity ORDER BY activity_date DESC');
?>
<!DOCTYPE html>
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left ml-1 col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Activités</strong></h3>
      </div>
      <div class="content-body ml-1">
        <div class="col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header card-head-inverse bg-warning bg-darken-4">
                <h4 class="card-title">Tâches réalisés</h4>
              </div>
