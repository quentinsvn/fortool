            ...
            <div class="tcontainern">
                <div class="n_">
                    ...
                    <button id="th" class="th" aria-controls="primary-menu" aria-expanded="false">
                        ...
                        <span class="tp">
                            <span class="td"></span></span></button>
                    <nav id="nj" class="nj">
                        <div class="nq">
                            <ul class="sr h re">
                                <li>
                            ...
                            <ul class="sr re">
                                <li>
                                    <a class="tbuttonn fbuttonl gbuttony gbuttony sbuttono" href="../account/login.php">Se
                                        connecter</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="scontainero">
                            ...
                            <p><b>Client&nbsp;:</b>&nbsp;tout professionnel ou personne physique capable au sens des
                                ...
                                <b>Prestations et Services&nbsp;:</b> <a
                                    href="https://fortool.fr">https://fortool.fr</a> met à disposition des
                                Clients&nbsp;:</p>

                            <p><b>Contenu&nbsp;:</b>&nbsp;Ensemble des éléments constituants l’information présente sur
                                le Site, notamment textes – images – vidéos.</p>

                            <p><b>Informations clients&nbsp;:</b> Ci après dénommé «&nbsp;Information (s)&nbsp;» qui
                                correspondent à l’ensemble des données personnelles susceptibles d’être détenues par <a
                                    href="https://fortool.fr">https://fortool.fr</a> pour la gestion de votre compte, de
                                la gestion de la relation client et à des fins d’analyses et de statistiques.</p>


                            <p><b>Utilisateur :</b> Internaute se connectant, utilisant le site susnommé.</p>
                            <p><b>Informations personnelles :</b> « Les informations qui permettent, sous quelque forme
                            ...
                            <p>Les termes «&nbsp;données à caractère personnel&nbsp;», «&nbsp;personne concernée&nbsp;»,
                            ...
                            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans
                                l'économie numérique, il est précisé aux utilisateurs du site internet&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>&nbsp;l'identité des différents
                                intervenants dans le cadre de sa réalisation et de son suivi:
                            </p>
                            <p><strong>Propriétaire</strong> : Fortool - Quentin Savéan<br>

                                <strong>Responsable publication</strong> : Quentin Savéan – admin@fortool.net<br>
                                Le responsable publication est une personne physique ou une personne morale.<br>
                                <strong>Webmaster</strong> : Quentin Savéan – admin@fortool.net<br>
                                <strong>Hébergeur</strong> : OVH – 2 rue Kellermann 59100 Roubaix 1007<br>
                                <strong>Délégué à la protection des données</strong> : Quentin Savéan – admin@fortool.net<br>
                            </p>
                            ...
                            <p>L’utilisation du site&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>&nbsp;implique l’acceptation pleine
                                ...
                                utilisateurs du site&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;sont
                            ...
                            <p>Ce site internet est normalement accessible à tout moment aux utilisateurs. Une
                                interruption pour raison de maintenance technique peut être toutefois décidée par <a
                                    href="https://fortool.fr">https://fortool.fr</a>, qui s’efforcera alors de
                                communiquer préalablement aux utilisateurs les dates et heures de l’intervention.
                                Le site web&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;est mis à jour
                                régulièrement par <a href="https://fortool.fr">https://fortool.fr</a> responsable. De la
                            ...
                            <p>Le site internet&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;a pour
                                objet de fournir une information concernant l’ensemble des activités de la société.
                                <a href="https://fortool.fr">https://fortool.fr</a> s’efforce de fournir sur le
                                site&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;des informations
                                aussi précises que possible. Toutefois, il ne pourra être tenu responsable des oublis,
                            ...
                            <p>Toutes les informations indiquées sur le site&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>&nbsp;sont données à titre
                                indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur
                                le site&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;ne sont pas
                            ...
                            <p>Le site utilise la technologie JavaScript.
                                ...
                                Le site <a href="https://fortool.fr">https://fortool.fr</a> est hébergé chez un
                            ...
                            <p><a href="https://fortool.fr">https://fortool.fr</a> et l’hébergeur ne pourront être tenus
                            ...
                            <p><a href="https://fortool.fr">https://fortool.fr</a> est propriétaire des droits de
                                ...
                                interdite, sauf autorisation écrite préalable de : <a
                                    href="https://fortool.fr">https://fortool.fr</a>.</p>
                            ...
                            <p><a href="https://fortool.fr">https://fortool.fr</a> agit en tant qu’éditeur du site. <a
                                    href="https://fortool.fr">https://fortool.fr</a> &nbsp;est responsable de la qualité
                                et de la véracité du Contenu qu’il publie. </p>

                            <p><a href="https://fortool.fr">https://fortool.fr</a> ne pourra être tenu responsable des
                                dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au
                                site internet <a href="https://fortool.fr">https://fortool.fr</a>, et résultant soit de
                            ...
                            <p><a href="https://fortool.fr">https://fortool.fr</a> ne pourra également être tenu
                                ...
                                d’une chance) consécutifs à l’utilisation du site&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>.
                                Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont
                                à la disposition des utilisateurs. <a href="https://fortool.fr">https://fortool.fr</a>
                                ...
                                particulier aux dispositions relatives à la protection des données. Le cas échéant, <a
                                    href="https://fortool.fr">https://fortool.fr</a> se réserve également la possibilité
                            ...
                            <p>Le Client est informé des réglementations concernant la communication marketing, la loi
                                du 21 Juin 2014 pour la confiance dans l’Economie Numérique, la Loi Informatique et
                                Liberté du 06 Août 2004 ainsi que du Règlement Général sur la Protection des Données
                                (RGPD&nbsp;: n° 2016-679). </p>

                            <h3>7.1 Responsables de la collecte des données personnelles</h3>

                            <p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel
                                de l’Utilisateur et de sa navigation sur le Site, le responsable du traitement des
                                Données Personnelles est : Fortool. <a
                                    href="https://fortool.fr">https://fortool.fr</a>est représenté par Quentin, son
                                représentant légal</p>

                            <p>En tant que responsable du traitement des données qu’il collecte, <a
                                    href="https://fortool.fr">https://fortool.fr</a> s’engage à respecter le cadre des
                                ...
                                de la collecte de leurs consentements, une information complète sur le traitement de
                                leurs données personnelles et de maintenir un registre des traitements conforme à la
                                réalité.
                                Chaque fois que <a href="https://fortool.fr">https://fortool.fr</a> traite des Données
                                Personnelles, <a href="https://fortool.fr">https://fortool.fr</a> prend toutes les
                                ...
                                Personnelles au regard des finalités pour lesquelles <a
                                    href="https://fortool.fr">https://fortool.fr</a> les traite.</p>
                            &nbsp;
                            <h3>7.2 Finalité des données collectées</h3>
                            &nbsp;
                            <p><a href="https://fortool.fr">https://fortool.fr</a> est susceptible de traiter tout ou
                            ...
                            <ul>
                                ...
                                <li>pour mener des enquêtes de satisfaction facultatives sur <a
                                        href="https://fortool.fr">https://fortool.fr</a> : adresse email </li>
                            ...
                            <p><a href="https://fortool.fr">https://fortool.fr</a> ne commercialise pas vos données
                            ...
                            <p>
                                Conformément à la réglementation européenne en vigueur, les Utilisateurs de <a
                                    href="https://fortool.fr">https://fortool.fr</a> disposent des droits suivants :
                            </p>
                            &nbsp;<ul>
                                ...
                                <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir
                                    à qui <a href="https://fortool.fr">https://fortool.fr</a> devra communiquer (ou non)
                                    ses données à un tiers qu’ils aura préalablement désigné</li>
                                &nbsp;
                            </ul>

                            <p>Dès que <a href="https://fortool.fr">https://fortool.fr</a> a connaissance du décès d’un
                                Utilisateur et à défaut d’instructions de sa part, <a
                                    href="https://fortool.fr">https://fortool.fr</a> s’engage à détruire ses données,
                            ...
                            <p>Si l’Utilisateur souhaite savoir comment <a
                                    href="https://fortool.fr">https://fortool.fr</a> utilise ses Données Personnelles,
                                demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter <a
                                    href="https://fortool.fr">https://fortool.fr</a> par écrit à l’adresse suivante :
                            </p>
                            &nbsp;
                            Fortool – DPO, Quentin <br>
                            23 Rue Charles de Gaulle 75001 Paris.
                            &nbsp;
                            <p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que
                                <a href="https://fortool.fr">https://fortool.fr</a> corrige, mette à jour ou supprime,
                                en s’identifiant précisément avec une copie d’une pièce d’identité (carte d’identité ou
                                passeport). </p>

                            <p>
                                Les demandes de suppression de Données Personnelles seront soumises aux obligations qui
                                sont imposées à <a href="https://fortool.fr">https://fortool.fr</a> par la loi,
                                notamment en matière de conservation ou d’archivage des documents. Enfin, les
                                Utilisateurs de <a href="https://fortool.fr">https://fortool.fr</a> peuvent déposer une
                            ...
                            <p>
                                <a href="https://fortool.fr">https://fortool.fr</a> s’interdit de traiter, héberger ou
                                ...
                                européenne sans en informer préalablement le client. Pour autant, <a
                                    href="https://fortool.fr">https://fortool.fr</a> reste libre du choix de ses
                            ...
                            <p>
                                <a href="https://fortool.fr">https://fortool.fr</a> s’engage à prendre toutes les
                                ...
                                incident impactant l’intégrité ou la confidentialité des Informations du Client est
                                portée à la connaissance de <a href="https://fortool.fr">https://fortool.fr</a>,
                                ...
                                mesures de corrections prises. Par ailleurs <a
                                    href="https://fortool.fr">https://fortool.fr</a> ne collecte aucune «&nbsp;données
                                sensibles&nbsp;».</p>

                            <p>
                                Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a
                                    href="https://fortool.fr">https://fortool.fr</a> et des sous-traitants (prestataires
                            ...
                            <p>
                                ...
                                Utilisateurs de <a href="https://fortool.fr">https://fortool.fr</a> sont principalement
                            ...
                            <p>
                                Aucune information personnelle de l'utilisateur du site&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>&nbsp;n'est publiée à l'insu de
                                l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des
                                tiers. Seule l'hypothèse du rachat de <a
                                    href="https://fortool.fr">https://fortool.fr</a> et de ses droits permettrait la
                                ...
                                l'utilisateur du site&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>.</p>

                            <h3>Sécurité</h3>

                            <p>
                                Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données
                                Personnelles de Santé, <a href="https://fortool.fr">https://fortool.fr</a> utilise des
                            ...
                            <p>
                                Lors du traitement des Données Personnelles, <a
                                    href="https://fortool.fr">https://fortool.fr</a>prend toutes les mesures
                            ...
                            <p>
                                Le site&nbsp;<a href="https://fortool.fr">https://fortool.fr</a>&nbsp;contient un
                                certain nombre de liens hypertextes vers d’autres sites, mis en place avec
                                l’autorisation de <a href="https://fortool.fr">https://fortool.fr</a>. Cependant, <a
                                    href="https://fortool.fr">https://fortool.fr</a> n’a pas la possibilité de vérifier
                                le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité
                                de ce fait.</p>
                            ...
                            &nbsp;<p>
                                <a href="https://fortool.fr">https://fortool.fr</a> est susceptible de traiter les
                                ...
                                consultées, les recherches effectuées. Ces informations permettent à <a
                                    href="https://fortool.fr">https://fortool.fr</a> d’améliorer le contenu du Site, de
                            ...
                            &nbsp;<p>
                                ...
                                <a href="https://fortool.fr">https://fortool.fr</a> informe l’Utilisateur que, dans ce
                            ...
                            &nbsp;<p>
                                ...
                                également être le cas lorsque <a href="https://fortool.fr">https://fortool.fr</a> ou
                                ...
                                ou le pays depuis lequel le terminal semble connecté à Internet.</p>
                            &nbsp;<p>
                                Le cas échéant, <a href="https://fortool.fr">https://fortool.fr</a> décline toute
                                ...
                                services éventuellement proposés par <a
                                    href="https://fortool.fr">https://fortool.fr</a>, résultant (i) du refus de Cookies
                                par l’Utilisateur (ii) de l’impossibilité pour <a
                                    href="https://fortool.fr">https://fortool.fr</a> d’enregistrer ou de consulter les
                            ...
                            &nbsp;<p>
                                ...
                                en matière de Cookies. <a href="https://fortool.fr">https://fortool.fr</a> pourra en
                            ...
                            &nbsp;<p>
                                ...
                                Linkedin et Google Plus figurant sur le Site de <a
                                    href="https://fortool.fr">https://fortool.fr</a> ou dans son application mobile et
                                si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation sur le Site
                                Internet ou l’application mobile de <a href="https://fortool.fr">https://fortool.fr</a>,
                                Twitter, Facebook, Linkedin et Google Plus peuvent également déposer des cookies sur vos
                            ...
                            &nbsp;<p>
                                ...
                                de <a href="https://fortool.fr">https://fortool.fr</a>. À tout moment, l’Utilisateur
                                peut néanmoins revenir sur son consentement à ce que <a
                                    href="https://fortool.fr">https://fortool.fr</a> dépose ce type de cookies.</p>
                            &nbsp;
                            ...
                            <p>
                                ...
                                <a href="https://fortool.fr">https://fortool.fr</a> peut employer occasionnellement des
                            ...
                            <p>
                                ...
                                &nbsp;</p>
                            <p>
                                Cette technologie permet à <a href="https://fortool.fr">https://fortool.fr</a> d’évaluer
                                les réponses des visiteurs face au Site et l’efficacité de ses actions (par exemple, le
                            ...
                            &nbsp;<p>
                                ...
                                rapports sur l’activité du Site à l’attention de <a
                                    href="https://fortool.fr">https://fortool.fr</a>, et fournir d’autres services
                            ...
                            <p>
                                Tout litige en relation avec l’utilisation du site&nbsp;<a
                                    href="https://fortool.fr">https://fortool.fr</a>&nbsp;est soumis au droit français.
                                En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de
                                juridiction aux tribunaux compétents de </p>

                        </div>
                    </div>
                </div>
            </section>
            <section class="is nx ft iy r">
                <div class="tcontainern">
                    <div class="st rd iu">
                        <div class="io">
                            <h3 class="ot">Nous rejoindre maintenant !</h3>
                        </div>
                        <div class="cta-action">
                            <div class="tu">
                                <form action="../account/register.php" method="GET">
                                    <label for="register" class="x sn">S'inscrire</label> 
                                    <input name="email" id="register" class="j" type="text" placeholder="Adresse e-mail">
                                    <svg width="16" height="12" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5H1c-.6 0-1 .4-1 1s.4 1 1 1h8v5l7-6-7-6v5z" fill="#F76700" fill-rule="nonzero"></path>
                                    </svg>
                ...
                <div class="ri">
                    <div class="rs rh h">
                        ...
                        <div class="rl">
                            <ul class="sr">
                                <li>
                                    <a href="https://discord.fortool.fr" target="__blank"
                                        style="text-decoration: none;">
                                        <i class="fab fa-discord"></i>
                                    </a>
                                </li>
                                <li>
                                    <a target="__blank" href="https://www.youtube.com/channel/UC5ppKq8W79oqn3mmpN8uWhA"
                                        style="text-decoration: none;">
                                        <i class="fab fa-youtube"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://medium.com/@fortool" target="__blank"
                                        style="text-decoration: none;">
                    ...
                    <div class="ro rh h rp">
                        <nav class="rc">
                            <ul class="sr">
                                ...
                                <li><a href="cgu.php">Mentions légales & CGU</a></li>
