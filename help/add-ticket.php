...
if(isset($_SESSION['id'])) {
    ...
    $user = $requser->fetch();
    include("../includes/include_add_ticket.php");
?>
<!DOCTYPE html>
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left ml-1 col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Aide -</strong> Ouverture d'un ticket</h3>
      </div>
      <?php 
            if(isset($message)) {
                echo $message;
        ...
        <div class="col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header card-head-inverse bg-warning bg-darken-4">
                <h4 class="card-title">Ouvrir une demande</h4>
              </div>
                    ...
                    <form class="form" method="post">
                        <div class="form-body">
                            <div class="form-group">
                                <label for="eventRegInput1">Objet</label>
                                <input type="text" name="objet" id="eventRegInput1" class="form-control" placeholder="Objet de la demande">
                            </div>
                            <div class="form-group">
                              <fieldset class="form-group">
                                    <label for="basicSelect">Priorité</label>
                                    <select name="priority" class="form-control" id="basicSelect">
                            ...
                            <div class="form-group">
                                <label for="donationinput7">Message</label>
                                <textarea name="message" id="donationinput7" rows="5" class="form-control" placeholder="Message"></textarea>
                            </div>
                        </div>

                        <div class="form-actions center">
                            <button type="reset" class="btn white bg-danger bg-darken-4 mr-1">
                                <i class="fas fa-times"></i> Annuler
                            </button>
                            <button name="confirm" type="submit" class="btn btn-primary">
