                        ...
                        <nav class="drawer-main">
                            <ul class="nav nav-drawer">
                                ...
                                <li class="nav-item active">
                                    <a href=""><i class="ion-ios-videocam-outline"></i> Tipeeestream</a>
                                </li>
                ...
                <main class="app-layout-content">
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4>Clips regardés du mois</h4>
                            </div>
                            <div class="card-block" style="text-align: center;">
                                <iframe width="500" height="400" src="https://widget.clipeee.com/tipeeeestream/dfe8965bad690c2e25154b5cf3aec97831e4f32dc3f67cb635da100b81076fb4" frameborder="0"></iframe>                                
                            <!-- .card-block -->
                        </div>
                    </div>
                    <!-- End Page Content -->
