					...
					?>                    
                        <div class="card">
                            <div class="card-header">
                                <h4>Créer un récompense</h4>
                            </div>
                            <div class="card-block">
                                <form action="" method="POST">
                                    <div class="form-group">
                                        <label for="code">Code</label>
                                        <input class="form-control" type="text" id="code" name="code" placeholder="Entrer un code...">
                                    </div>
                                    <div class="form-group">
                                        <label for="amount">Montant</label>
                                        <input class="form-control" type="number" id="amount" name="amount" placeholder="Entrer le montant...">
                                    </div>
