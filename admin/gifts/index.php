...
if(isset($_SESSION['id'])) {
    ...
    $gifts = $bdd->query('SELECT * FROM gifts ORDER BY id');
                    ...
                    <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer table-responsive">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">#</th>
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Date</th>
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Code</th>
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Créer par</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1">Pseudo</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1">Récompense</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1">Utilisé</th>
                                            <th class="sorting_disabled">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php while($g = $gifts->fetch()) { ?>
                                        <?php 
                                            $phpdate = strtotime($g['date']);
                                            $g['date'] = date( 'd/m/Y H:m:s', $phpdate );
                                        ?>          
                                        <tr role="row" class="odd">
                                        <td class="hidden-xs"><?php echo $g['id'] ?></td>
                                            <td class="hidden-xs"><?php echo $g['date'] ?></td>
                                            <td class="hidden-xs"><?php echo $g['cle'] ?></td>
                                            <td class="hidden-xs"><?php echo $g['creator'] ?></td>
                                            <td class="font-500"><?php echo $g['pseudo'] ?></td>
                                            <td><?php echo $g['reward'] ?> Fortcoins</td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="edit_gift.php?edit=<?php echo $g['id']; ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Editer"><i class="ion-edit"></i></a>
                                                    <button name="delete" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Supprimer"><i class="fas fa-trash-alt"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php } ?>
