                                ...
                                <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer table-responsive">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Inscription</th>
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Modification</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1">Solde</th>
                                            <th class="hidden-xs" tabindex="0" aria-controls="DataTables_Table_1">Staff</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            ...
                                            $phpdate2 = strtotime($m['date_modification']);
                                            $m['date_modification'] = date( 'd/m/Y H:i:s', $phpdate2 ); 
                                        ?>          
                                        <tr role="row" class="odd">
                                        <td class="hidden-xs"><?php echo $m['id'] ?></td>
                                            <td class="hidden-xs"><?php echo $m['date_inscription'] ?></td>
                                            <td class="hidden-xs"><?php echo $m['date_modification'] ?></td>
                                            <td class="font-500"><?php echo $m['pseudo'] ?></td>
                                            <td><?php echo $m['email'] ?></td>
                                            <td><?php echo $m['solde'] ?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="edit_user.php?edit=<?php echo $m['id']; ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Editer"><i class="ion-edit"></i></a>
                                                    <button name="ban" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Bannir"><i class="fas fa-ban"></i></button>
