                            ...
                            <div class="card-block">
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['pseudo']; } ?>" type="text" id="pseudo" name="pseudo" placeholder="Pseudo de l'utilisateur">
                                    </div>
                                    <?php } ?>
                                    <div class="form-group">
                                        <label for="prenom">Prénom</label>
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['prenom']; } ?>" type="text" id="prenom" name="prenom" placeholder="Entrer le prénom...">
                                    </div>
                                    <div class="form-group">
                                        <label for="nom">Nom</label>
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['nom']; } ?>" type="text" id="nom" name="nom" placeholder="Entrer le nom...">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Adresse e-mail</label>
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['email']; } ?>" type="email" id="email" name="email" placeholder="Entrer une adresse mail...">
                                    </div>
                                    <div class="form-group">
                                        <label for="tel">Numéro de téléphone (falcultatif)</label>
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['tel']; } ?>" type="number" id="tel" name="tel" placeholder="Entrer un numéro de téléphone...">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php if($mode_edition == 1) { echo $edit['solde']; } ?>" type="number" id="solde" name="solde" placeholder="Solde de l'utilisateur">
                                    </div>
                                    <?php } ?>
                                    <div class="form-group">
                                        <label>Rôles</label>
                                        <p>
                                            <label class="css-input switch switch-primary">
								                <input name="staff" <?php if($mode_edition == 1 && $edit['staff'] == 1) { echo 'checked=""'; } ?> value="<?php echo $staff_check; ?>" type="checkbox"><span></span> Staff
							                </label>
                                        </p>
                                        <p>
                                            <label class="css-input switch switch-primary">
								                <input name="admin" <?php if($mode_edition == 1 && $edit['admin'] == 1) { echo 'checked=""'; } ?> value="<?php echo $admin_check; ?>" type="checkbox"><span></span> Admin
							                </label>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <label class="css-input switch switch-primary">
								                <input name="suspended" <?php if($mode_edition == 1 && $edit['suspended'] == 1) { echo 'checked=""'; } ?> value="<?php echo $suspended_check; ?>" type="checkbox"><span></span> Suspendre le compte
							                </label>
                                        </p>
                                        <label class="css-input css-checkbox css-checkbox-default">
                                            <input name="newsletter" <?php if($mode_edition == 1 && $edit['newsletter'] == 1) { echo 'checked=""'; } ?> value="<?php echo $newsletter_check; ?>" type="checkbox"><span></span> Recevoir la newsletter du site par e-mail</br>
                                        </label><br/>
                                        <?php if($mode_edition == 0) { ?>
                                        <label class="css-input css-checkbox css-checkbox-default">
