                ...
                <main class="app-layout-content">
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4>Liste des commandes effectuée</h4>
                                ...
                                <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer table-responsive">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">REF</th>
                                            ...
                                            <th class="hidden-xs sorting" tabindex="0" aria-controls="DataTables_Table_1">Identifiant</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td class="hidden-xs"><?php echo $o['id'] ?></td>
                                            <td class="hidden-xs"><?php echo $o['ref'] ?></td>
                                            <td class="hidden-xs"><?php echo $o['date'] ?></td>
                                            <td class="font-500"><?php echo $o['name'] ?></td>
                                            <td class="hidden-xs"><?php echo $o['identifiant'] ?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <form method="post">
                                                        <button name="send" class="btn btn-xs btn-default" type="input" data-toggle="tooltip" title="" data-original-title="Envoyé"><i class="fas fa-check"></i></a>
                                                        ...
                                                        <button name="refuse" class="btn btn-xs btn-default" type="input" data-toggle="tooltip" title="" data-original-title="Refusé"><i class="fas fa-ban"></i></button>
                                                    </form>  
                                                </div>
                                            </td>
                                        </tr>
