...
include('../includes/config.php');
    if(isset($_SESSION['id'])) {
        ...
        $membres = $bdd->query('SELECT * FROM users ORDER BY solde DESC LIMIT 0,10');
?>
<!DOCTYPE html>
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left ml-1 col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Classement</strong></h3>
      </div>
      <div class="content-body ml-1">
        <div class="col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header card-head-inverse bg-warning bg-darken-4">
                <h4 class="card-title">Classement des utilisateurs les plus actifs</h4>
              </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="align-middle">
                              <span><?php echo $m['pseudo']; ?></span>
                            </td>
                            <td class="align-right">
                              <span><?php echo $m['solde']; ?> Fortcoins</span>
                            </td>             
                          </tr>
                          <?php
                            }
