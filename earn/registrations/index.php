<?php
    ...
    if(isset($_SESSION['id'])) {
        ...
        $user = $requser->fetch();
        $json = file_get_contents("http://adscendmedia.com/adwall/api/publisher/115180/profile/16970/offers.json?subid1=".$user['id']."&subid2=".$user['pseudo']."&category_id=24&limit=10");
        $data=array();
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Inscriptions sur des sites</strong></h3>
      </div>
            ...
            <div class="col-xl-3 col-md-4 col-sm-12">
              <div class="card">
                <div class="card-content">
                  <img class="card-img-top img-fluid" src="<?php echo $pc["image_url"]; ?>">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $pc["name"]; ?></h4>
                    <p class="card-text">Validez vite votre participation sur notre site partenaire ! <strong>Attention à entrer de véritables informations et accepter les offres partenaires pour recevoir vos Fortcoins.</strong></p>
                    <p class="card-text">
                    ...
                    <div class="card-body">
                      <a href="<?php echo $pc["click_url"]; ?>" target="__blank" class="btn btn-outline-warning bg-darken-4">Je m'inscris</a>
                    </div>    
                  </div>
                </div>
              </div>
