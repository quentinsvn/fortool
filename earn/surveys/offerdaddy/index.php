  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Sondages</strong>- OfferDaddy</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <!-- OfferDaddy -->
            <div class="col-12">
                <iframe src="https://www.offerdaddy.com/survey_widget/w/75824/<?php echo $user['id']; ?>/<?php echo $user['pseudo']; ?>" frameborder="0" style="width:100%; height:800px;"></iframe>
            </div>
        </div>
        <!-- -->
      </div>
