<?php
  ...
  if($is_valid) {
    ...
    $activity = "INSERT INTO activity (ref, activity_date, pseudo, type, name, earning, status) VALUES ('FTACT$ref', now(), '$request_uuid', 'Sondage', 'Sondage - Pollfish', '$reward_value', '$status')";
