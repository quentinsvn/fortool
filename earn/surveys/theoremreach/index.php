  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Sondages</strong>- TheoremReach</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <!-- OfferDaddy -->
            <div class="col-12">
              <iframe frameborder="0" src="https://theoremreach.com/respondent_entry/direct?api_key=50508b5cdd5d51dd48ab0d24f12d&user_id=<?php echo $user['id']; ?>" width="100%" height="1200" allowfullscreen></iframe>
            </div>
        </div>
        <!-- -->
      </div>
