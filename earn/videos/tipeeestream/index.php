<?php
    ...
    if(isset($_SESSION['id'])) {
        ...
        $user = $requser->fetch();
        include('../../../includes/tipeeestream_v2.php');
?>
<!DOCTYPE html>
          ...
          <ul class="nav navbar-nav float-right">
            <li class="nav-item">
              <a class="nav-link">
                ...
                <span class="resultat" style="font-weight: bold;"><?php echo $user['solde']; ?> FT</span>
              </a>
            </li>
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Vidéos</strong>- Tipeeestream</h3>
      </div>
      <div class="alert bg-warning alert-icon-left alert-dismissible mb-2" role="alert">
						<strong>Attention!</strong> Veillez à bien renseigner votre pseudo Fortool dès que notre partenaire vous le demanderas dès le début
            de votre session de visionnage de vidéo(s) pour bien recevoir vos Fortcoins. Pour rappel, votre pseudo est <strong><?php echo $user['pseudo']; ?></strong>
				</div>
      <div class="content-body">

        <!-- Tipeeestream -->
        <div class="row">
            <iframe frameborder="0" width="100%" height="1000" src="https://www.tipeeestream.com/fortool-fr/donation" frameborder="0"></iframe>
        </div>
        <!-- -->
      </div>
    </div>
        ...
        function refresh_div() {
            jQuery.ajax({
                ...
                success:function(results) {
                    jQuery(".resultat").html(results).append( " FT" );
                }
            });
        }
