  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Offerwalls</strong>- Wannads</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <div class="col-12">
              <iframe style="width:100%;height:850px;border:0;padding:0;margin:0;" scrolling="yes" frameborder="0" src="https://wall.wannads.com/wall?apiKey=5e53cf825a697880476368&userId=<?php echo $user['id']; ?>&subId2=<?php echo $user['pseudo']; ?>"></iframe>
            </div>
        </div>
        <!-- -->
      </div>
