  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Offerwalls</strong>- OfferDaddy</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <div class="col-12">
              <iframe src="https://www.offerdaddy.com/wall/75824/<?php echo $user['id']; ?>/<?php echo $user['pseudo']; ?>" frameborder="0" width="100%" height="1200" ></iframe>
            </div>
        </div>
        <!-- -->
      </div>
