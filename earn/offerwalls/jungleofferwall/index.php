  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Offerwalls</strong>- JungleOfferWall</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <!-- OfferDaddy -->
            <div class="col-12">
              <iframe src="https://jungleofferwall.com/offerwall/639/<?php echo $user['id']; ?>" width="100%" height="1200" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <!-- -->
      </div>
