  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Offerwalls</strong>- AdscendMedia</h3>
      </div>
      <div class="content-body">
        ...
        <div class="row">
            <!-- OfferDaddy -->
            <div class="col-12">
              <iframe src="https://asmwall.com/adwall/publisher/115180/profile/16970?subid1=<?php echo $user['id']; ?>&subid2=<?php echo $user['pseudo']; ?>" width="100%" height="1200" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <!-- -->
      </div>
