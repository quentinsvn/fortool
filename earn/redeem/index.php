  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Obtenir votre récompense</strong></h3>
      </div>
            ...
            <div class="col-12 col-md-12 col-sm-12">
              <div class="card">
                <div class="card-header card-head-inverse bg-warning bg-darken-4">
                  <h4 class="card-title">Utiliser votre code</h4>
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form method="POST">
                      <div class="input-group">
                        <input type="text" name="code" class="form-control" placeholder="Entrer votre code de récompense" aria-describedby="button-addon2">
                      </div>
                      <div class="input-group">
                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-2">
                            <button name="confirm" type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Échanger</button>
                        </div>
                      </div>
                    </form>
