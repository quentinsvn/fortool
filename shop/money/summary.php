<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 5 && !empty($_GET['amount'] == 5) &&  $user['solde'] >= 650 || isset($_GET['amount']) == 10 && !empty($_GET['amount'] == 10 && $user['solde'] >= 1300 || isset($_GET['amount']) == 20 && !empty($_GET['amount'] == 20 && $user['solde'] >= 2600))) {
        if($_GET['amount'] == 5) {
            $title = "PayPal 5€";
            $montant = 650;
        }
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://lh3.googleusercontent.com/Y2_nyEd0zJftXnlhQrWoweEvAy4RzbpDah_65JGQDKo9zCcBxHVpajYgXWFZcXdKS_o";
                            ...
                            <span class="float-right">
                                <?php 
                                    if($user['paypal']) 
                                    {
                                        ...
                                        echo "Veuillez renseigner une adresse e-mail Paypal !";
                                    }  
                                ?>
                            </span>
                            <i class="fas fa-envelope"></i> Adresse e-mail PayPal
                        </li>
                        <li class="list-group-item">
                                ...
                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-2">
                                    ...
                                    ?>
                                        <a href="../settings" class="btn btn-primary">
                                            Renseigner mon adresse e-mail Paypal
                                        </a>
                                    <?php
                                        }
                                    ?>
