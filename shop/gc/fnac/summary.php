<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 15 && !empty($_GET['amount'] == 15) &&  $user['solde'] >= 1950 || isset($_GET['amount']) == 30 && !empty($_GET['amount'] == 30 && $user['solde'] >= 3900 || isset($_GET['amount']) == 50 && !empty($_GET['amount'] == 50 && $user['solde'] >= 6500))) {
        if($_GET['amount'] == 15) {
            $title = "Fnac 15€";
            $montant = 3250;
        }
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://www.stickpng.com/assets/images/5a32b7cacb9a85480a628fa7.png";
