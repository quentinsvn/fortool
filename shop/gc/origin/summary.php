<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 15 && !empty($_GET['amount'] == 15) &&  $user['solde'] >= 1950 || isset($_GET['amount']) == 20 && !empty($_GET['amount'] == 20 && $user['solde'] >= 2600 || isset($_GET['amount']) == 30 && !empty($_GET['amount'] == 30 && $user['solde'] >= 3900))) {
        if($_GET['amount'] == 15) {
            $title = "Origin 15€";
            $montant = 1950;
        }
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://www.stickpng.com/assets/images/5b447f12e99939b4572e32c0.png";
