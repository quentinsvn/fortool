    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Origin</strong></h3>
            </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1950) { ?>
                                        <a href="summary.php?amount=15" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 3900) { ?>
                                        <a href="summary.php?amount=30" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
