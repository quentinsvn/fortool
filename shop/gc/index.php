    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Cartes cadeaux</strong></h3>
            </div>
            <div class="content-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Amazon</h4>
                    </div>
                    <!-- -->
                    <!-- Amazon 5€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Amazon 5€</h4>
                            </div>
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 650) { ?>
                                        <a href="amazon/summary.php?amount=5" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Amazon 10€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1300) { ?>
                                        <a href="amazon/summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Amazon 20€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 2600) { ?>
                                        <a href="amazon/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                ...
                <div class="row">
                    <!-- Title -->
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Fnac</h4>
                    </div>
                    <!-- -->
                    <!-- Fnac 15€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Fnac 15€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1950) { ?>
                                        <a href="fnac/summary.php?amount=15" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Fnac 30€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 3900) { ?>
                                        <a href="fnac/summary.php?amount=30" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Fnac 50€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 6500) { ?>
                                        <a href="fnac/summary.php?amount=50" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                ...
                <div class="row">
                    <!-- Title -->
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Steam</h4>
                    </div>
                    <!-- -->
                    <!-- Steam 5€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Steam 5€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                        <img style="width: 100%;"
                                            src="../../app-assets/images/shop/steam.png" alt="">
                                    </p>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 970) { ?>
                                        <a href="steam/summary.php?amount=5" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Steam 10€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1560) { ?>
                                        <a href="steam/summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Steam 20€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 2600) { ?>
                                        <a href="steam/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                ...
                <div class="row">
                    <!-- Title -->
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Origin</h4>
                    </div>
                    <!-- -->
                    <!-- Origin 15€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Origin 15€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1950) { ?>
                                        <a href="origin/summary.php?amount=15" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Origin 20€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 2600) { ?>
                                        <a href="origin/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Origin 30€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 3900) { ?>
                                        <a href="origin/summary.php?amount=30" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
