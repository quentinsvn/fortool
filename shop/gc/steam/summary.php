<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 5 && !empty($_GET['amount'] == 5) &&  $user['solde'] >= 970 || isset($_GET['amount']) == 10 && !empty($_GET['amount'] == 10 && $user['solde'] >= 1560 || isset($_GET['amount']) == 20 && !empty($_GET['amount'] == 20 && $user['solde'] >= 2600))) {
        if($_GET['amount'] == 5) {
            $title = "Steam 5€";
            $montant = 970;
        }
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://www.pngitem.com/pimgs/m/23-238119_steam-logo-png-transparent-png.png";
