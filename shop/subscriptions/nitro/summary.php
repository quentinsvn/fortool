<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 5 && !empty($_GET['amount'] == 5) &&  $user['solde'] >= 650 || isset($_GET['amount']) == 10 && !empty($_GET['amount'] == 10 && $user['solde'] >= 1300)) {
        if($_GET['amount'] == 5) {
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://images.discordapp.net/avatars/482584715673600026/3813e13cf3e89eb5ab314dcda58f5d96.png?size=512";
