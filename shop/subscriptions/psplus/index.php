                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="nav-item">
                            <a class="nav-link">
                                ...
                                <span style="font-weight: bold;">3210 FT</span>
                            </a>
                        </li>
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                ...
                                <span class="user-name">Quentin</span>
                            </a>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Playstation Plus 1 mois</strong></h3>
            </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 7800) { ?>
                                    <a href="summary.php?amount=60" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
