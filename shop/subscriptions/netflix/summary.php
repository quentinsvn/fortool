<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 25 && !empty($_GET['amount'] == 25) &&  $user['solde'] >= 3250 || isset($_GET['amount']) == 50 && !empty($_GET['amount'] == 50 && $user['solde'] >= 6500 || isset($_GET['amount']) == 100 && !empty($_GET['amount'] == 100 && $user['solde'] >= 13000))) {
        if($_GET['amount'] == 25) {
            $title = "Netflix 25€";
            $montant = 3250;
        }
                    ...
                    <form method="post">
                        <div class="input-group">
                          <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-2">
                            <button name="confirm" type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Confirmer</button>
                          </div>
                        </div>
                    </form>
