    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>League Of Legends</strong></h3>
            </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                      <?php if($user['solde'] >= 3250) { ?>
                                          <a href="summary.php?amount=25" class="btn btn-outline-warning">Commander</a>
                                      <?php } else { ?>
                                          <div class="badge badge-danger">Solde insuffisant</div>
                                      <?php } ?>
                                </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 4550) { ?>
                                    <a href="summary.php?amount=35" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
