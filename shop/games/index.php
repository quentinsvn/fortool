    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Jeux</strong></h3>
            </div>
            <div class="content-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">League of Legends</h4>
                    </div>
                    <!-- -->
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">League of Legends 20€</h4>
                            </div>
                                ...
                                <div class="card-body text-right">
                                  <div class="card-body text-right">
                                      <?php if($user['solde'] >= 2600) { ?>
                                          <a href="lol/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                      <?php } else { ?>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">League of Legends 25€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                      <?php if($user['solde'] >= 3250) { ?>
                                          <a href="lol/summary.php?amount=25" class="btn btn-outline-warning">Commander</a>
                                      <?php } else { ?>
                                          <div class="badge badge-danger">Solde insuffisant</div>
                                      <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">League of Legends 35€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 4550) { ?>
                                    <a href="lol/summary.php?amount=35" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                ...
                <div class="row">
                    <!-- Title -->
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Roblox</h4>
                    </div>
                    <!-- -->
                    <!-- Roblox 10€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Roblox 10€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 2600) { ?>
                                    <a href="roblox/summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Roblox 25€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 3250) { ?>
                                    <a href="roblox/summary.php?amount=25" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Roblox 50€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 4550) { ?>
                                    <a href="roblox/summary.php?amount=50" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
