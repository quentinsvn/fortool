    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Cryptomonnaies</strong></h3>
            </div>
            <div class="content-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Bitcoin 2€</h4>
                            </div>
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 260) { ?>
                                    <a href="btc/summary.php?amount=2" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Bitcoin 5€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    ...
                                    <a href="btc/summary.php?amount=5" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Bitcoin 10€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    ...
                                    <a href="btc/summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Bitcoin 20€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    ...
                                    <a href="btc/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                ...
                <div class="row">
                    <!-- Title -->
                    <div class="col-md-12 mb-2">
                        <h4 class="text-uppercase">Ethereum</h4>
                    </div>
                    <!-- -->
                    <!-- Ethereum 2€ -->
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Ethereum 2€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 260) { ?>
                                        <a href="eth/summary.php?amount=2" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Ethereum 5€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 650) { ?>
                                        <a href="eth/summary.php?amount=5" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Ethereum 10€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 1300) { ?>
                                        <a href="eth/summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="card">
                            <div class="card-header card-head-inverse bg-warning bg-darken-4">
                                <h4 class="card-title">Ethereum 20€</h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body" style="padding: 0 !important">
                                    <p class="card-text" style="text-align: center;">
                                ...
                                <div class="card-body text-right">
                                    <?php if($user['solde'] >= 2600) { ?>
                                        <a href="eth/summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                    <?php } else { ?>
                                        <div class="badge badge-danger">Solde insuffisant</div>
                                    <?php } ?>
                                </div>
