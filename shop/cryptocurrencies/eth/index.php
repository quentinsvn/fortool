    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header-left col-md-6 col-12 mb-2 row">
                <h3 class="content-header-title mb-0"><strong>Ethereum</strong></h3>
            </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 260) { ?>
                                    <a href="summary.php?amount=2" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 650) { ?>
                                    <a href="summary.php?amount=5" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 1300) { ?>
                                    <a href="summary.php?amount=10" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body text-right">
                                  <?php if($user['solde'] >= 2600) { ?>
                                    <a href="summary.php?amount=20" class="btn btn-outline-warning">Commander</a>
                                  <?php } else { ?>
                                    <div class="badge badge-danger">Solde insuffisant</div>
                                  <?php } ?>
                                </div>
