<?php
    ...
    if(isset($_SESSION['id'])) {
      ...
      $user = $requser->fetch();
      if(isset($_GET['amount']) == 2 && !empty($_GET['amount'] == 2) &&  $user['solde'] >= 260 || isset($_GET['amount']) == 5 && !empty($_GET['amount'] == 5 && $user['solde'] >= 650 || isset($_GET['amount']) == 10 && !empty($_GET['amount'] == 10 && $user['solde'] >= 1300 || isset($_GET['amount']) == 20 && !empty($_GET['amount'] == 20 && $user['solde'] >= 2600)))) {
        if($_GET['amount'] == 2) {
            $title = "Ethereum 2€";
            $montant = 260;
        }
      ...
      if($_GET['amount'] == 20) {
        ...
        if(isset($_POST['confirm'])) {
            ...
            $pseudo = $user['pseudo'];
            $url_picture = "https://i.pinimg.com/originals/60/b9/b1/60b9b11b28fde9cc13dd039ce8514076.png";
                            ...
                            <span class="float-right">
                                <?php 
                                    if($user['eth']) 
                                    {
                                        ...
                                        echo "Veuillez renseigner votre adresse ETH depuis les paramètres de votre profil!";
                                    }  
                                ?>
                            </span>
                            <i class="fab fa-ethereum"></i> Adresse Ethereum
                        </li>
                        <li class="list-group-item">
                          ...
                          <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-2">
                                    ...
                                    ?>
                                        <a href="../../../settings" class="btn btn-primary">
                                            Renseigner mon adresse Ethereum
                                        </a>
                                    <?php
                                        }
                                    ?>
