...
include('../includes/config.php');
    if(isset($_SESSION['id'])) {
        ...
        $orders = $bdd->query('SELECT * FROM orders ORDER BY date DESC');
?>
<!DOCTYPE html>
  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
      <div class="content-header-left ml-1 col-md-6 col-12 mb-2 row">
        <h3 class="content-header-title mb-0"><strong>Commandes</strong></h3>
      </div>
      <div class="content-body ml-1">
        <div class="col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header card-head-inverse bg-warning bg-darken-4">
                <h4 class="card-title">Activités de mes commandes</h4>
              </div>
